...
parser.add_argument("--dataset", type=str, default="vitextcaps",
                    help="textvqa, stvqa, ocrvqa")
parser.add_argument("--visual_feat_path", type=str, default="/content/data/vinvl/vinvl_vinvl",)
parser.add_argument("--text_feat_path", type=str, default="/content/data/swintextspotter/swintextspotter",)
parser.add_argument("--image_path", type=str, default="/content/images/images",)
parser.add_argument("--save_path", type=str, default="/content/data/edge_feat",)
...
for img in tqdm(images):
    ...
    visual_path = args.visual_feat_path + "/" + img.split(".")[0] + ".npy"
    text_path = args.text_feat_path + "/" + img.split(".")[0] + ".npy"
    ...
    v_fea = np.load(visual_path, allow_pickle=True)[()]
    t_fea = np.load(text_path, allow_pickle=True)[()]

    obj_bbox = v_fea['region_boxes']
    ocr_bbox = t_fea['boxes']
    img_h = v_fea['width']
    img_w = v_fea['height']
